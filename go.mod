module github.com/whosonfirst/go-whosonfirst-spatial-atproto

go 1.25.0

require (
	github.com/aaronland/go-http/v3 v3.1.1
	...
	github.com/whosonfirst/go-whosonfirst-spatial-duckdb v0.3.2
)
